...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       mRecyclerView.addOnItemTouchListener(new RecyclerItem(getApplicationContext(),
    ...
    private void applyPalette() {
        ...
        fab.setBackgroundTintList(ColorStateList.valueOf(mPalette.getVibrantColor(defaultColor)));
